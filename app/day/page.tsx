...
export default function DayPage() {
  ...
  const [notes, setNotes] = useState<BaseItem[]>([]);
  const [budgets, setBudgets] = useState<BaseItem[]>([]);
  const [anniversaries, setAnniversaries] = useState<BaseItem[]>([]);
  ...
  const Card = ({ title, items }: { title: string; items: BaseItem[] }) => (
